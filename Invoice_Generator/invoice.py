...
class InvoiceGenerator:
    def __init__(self,root):
        ...
        Label(self.frame, text="Authorised Signatory", font=("times new roman", 15, "bold"), bg="white", fg="gray").place(
            x=50, y=500)
    ...
    def generate_invoice(self):
        c = canvas.Canvas("Invoice_Generator.pdf", pagesize=(200, 250), bottomup=0)
